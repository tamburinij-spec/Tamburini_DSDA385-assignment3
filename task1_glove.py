"""
Task 1 – Text Generation  |  GloVe Pretrained Embeddings
=========================================================
Trains and compares two architectures on the Shakespeare dataset
using frozen GloVe 100-d pretrained embeddings:
  - LSTM + GloVe
  - GRU  + GloVe
...
glove_matrix = load_glove_embeddings(GLOVE_PATH, word2idx, embed_size=EMBED_SIZE)
print("GloVe loaded.")
...
experiments = [
    ("LSTM + GloVe",
     LSTMModel(vocab_size, EMBED_SIZE, HIDDEN_SIZE, embedding_matrix=glove_matrix).to(device)),
    ("GRU  + GloVe",
     GRUModel (vocab_size, EMBED_SIZE, HIDDEN_SIZE, embedding_matrix=glove_matrix).to(device)),
]
